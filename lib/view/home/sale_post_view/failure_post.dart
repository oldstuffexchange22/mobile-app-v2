...
class FailurePost extends StatefulWidget {
  const FailurePost({Key? key}) : super(key: key);

  @override
  State<FailurePost> createState() => _FailurePostState();
}

class _FailurePostState extends State<FailurePost> {
  ...
  void initState() {
    ...
    postSaleProvider.getPostFailure();
  ...
  Widget build(BuildContext context) {
    ...
    List<Post> posts = postStatusProvider.failurePosts;
    return Scaffold(
      body: RefreshIndicator(
        onRefresh: () => postStatusProvider.getPostFailure(),
        child: posts.isEmpty
